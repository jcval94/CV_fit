...
def build_summary(
    *,
    ...
    for vacancy_id in sorted(ids):
        ...
        wa_status = wa_entries[-1].get("status") if wa_entries else None
        rows.append({
            ...
            "generation_cost_usd": bun.get("generation_cost_usd") or state.get("known_estimated_cost_usd") or state.get("estimated_cost_usd"),
            "cover_cost_usd": bun.get("cover_letter_cost_usd") or state.get("cover_letter_cost_usd"),
            "presentation_cost_usd": bun.get("presentation_cost_usd") or state.get("presentation_cost_usd"),
            "pipeline_cost_usd": bun.get("total_pipeline_known_cost_usd") or state.get("total_pipeline_known_cost_usd"),
